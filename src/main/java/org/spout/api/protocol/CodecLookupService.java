...
public abstract class CodecLookupService {
	 ...
	 */
	protected <T extends Message, C extends MessageCodec<T>> void bind(Class<C> clazz) 
	 ...
	 *             to an access violation.
	 */
	protected <T extends Message, C extends MessageCodec<T>> C bind(Class<C> clazz, StringMap dynamicPacketMap) 
			throws InstantiationException, IllegalAccessException, InvocationTargetException {
